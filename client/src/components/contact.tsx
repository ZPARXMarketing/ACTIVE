            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="http://x.com/zparxmarketing" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-black text-white rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
