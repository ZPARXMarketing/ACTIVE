      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="/lead-gen-offer" className="bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-colors font-semibold">
              Lead Generation
            </a>
            <button 
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-100">
            <div className="flex flex-col space-y-4 mt-4">
              ...
              <a href="/lead-gen-offer" className="bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-colors text-center font-semibold">
                Lead Generation
              </a>
              <button 
                onClick={() => scrollToSection("contact")} 
